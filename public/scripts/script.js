...
//EXAMPLE:
// answer = (x < y);
// console.log(`Is x less than y? | ${answer}`);

// answer = ();
// console.log(`Is x greater than y? | ${answer}`);

// answer = ();
// console.log(`Is y greater than or equal to z? | ${answer}`);

// answer = ();
// console.log(`Is x less than y? | ${answer}`);

// answer = ();
// console.log(`Is y less than or equal to x? | ${answer}`);

// answer = ();
// console.log(`Is y equal to z? | ${answer}`);

// answer = ();
// console.log(`Is y strictly equal to z? | ${answer}`);

// answer = ();
// console.log(`Is z not equal to x?  | ${answer}`);

// answer = ();
// console.log(`Is y not equal to z?  | ${answer}`);

// answer = ();
// console.log(`Is y strictly not equal to z?  | ${answer}`);
...
if (varY = "ten"){
   console.log(`The conditional statement is TRUE, so it executed this code.`)
}
...
if (varY) {
     ...
     console.log(`Boy, varY ain't a thing.`)
};
...
mathAnswer = (mathX + 15);
console.log(`mathX added to 15 = ${mathAnswer}`);

mathAnswer = (mathY - mathZ);
console.log(`mathY minus mathZ = ${mathAnswer}`);

mathAnswer = (mathY * 100);
console.log(`multiply mathY by 100 = ${mathAnswer}`);

mathAnswer = (mathZ ** 7);
console.log(`mathZ raised to the power of 7 = ${mathAnswer}`);

mathAnswer = (25 / mathY);
console.log(`25 divided by mathY = ${mathAnswer}`);

mathAnswer = (mathY % mathZ);
console.log(`the remainder of mathY divided by mathZ = ${mathAnswer}`);

mathAnswer = (++mathY);
console.log(`mathY incremented once = ${mathAnswer}`);

mathAnswer = (--mathX);
console.log(`mathX decremented once = ${mathAnswer}`);
...
console.log(`The variable theirAge is: ${theirAge} and it's a: ${typeof theirAge}`)
